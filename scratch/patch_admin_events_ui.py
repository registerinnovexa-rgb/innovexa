...
content = re.sub(r'    <button class="sidebar-btn" onclick="switchAdminTab\(\'forgeOps\'\)" id="navForgeOps">[\s\S]*?Forge Ops\n    </button>', sidebar_btn, content)
...
# Insert before </div> <!-- End Main Content -->
  ...
  <div class="modal-overlay" id="modalCreateEvent">
    <div class="modal-box">
      ...
      <div class="modal-actions">
        <button class="btn-cancel" onclick="closeModal('modalCreateEvent')">Cancel</button>
  ...
  <div class="modal-overlay" id="modalEventDash">
    <div class="modal-box" style="max-width:700px;">
      <div style="display:flex; justify-content:space-between; align-items:flex-start;">
        ...
        <button class="btn-cancel" onclick="closeModal('modalEventDash')">✕ Close</button>
      </div>
...
print("admin.html patched for Events UI!")
