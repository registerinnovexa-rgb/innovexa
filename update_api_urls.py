...
files.append('patch_auth_otp.py') # ignoring python scripts
...
OLD_URL = "'/api/backend"
NEW_URL = "'https://innovexa-backend-x57p.onrender.com/api/backend"
OLD_URL2 = "`/api/backend"
NEW_URL2 = "`https://innovexa-backend-x57p.onrender.com/api/backend"
